...
import org.acme.hibernate.orm.panache.application.Config;
...
public class FruitEntityResource {
    ...
    public FruitEntity getSingle(Long id) {
        LOGGER.info("In FruitEntityResource.getSingle()");
    ...
    public Response create(FruitEntity fruit) {
        ...
        if (Config.getFruitNameUppercaseForce()) {
            LOGGER.info("Uppercase is enabled");
